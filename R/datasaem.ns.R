#' @title Data generated based on Multivariate Fay Herriot Model with Additive Logistic Transformation with Non-Sampled Cases
#' @description This data is generated based on multivariate Fay-Herriot model and then transformed by using inverse Additive Logistic Transformation (alr). Then some domain would be edited to be non-sampled. The steps are as follows:
#' \enumerate{
...
#'   \item \eqn{c1}, \eqn{c2}, and \eqn{c3} are clusters performed using k-medoids algorithm with \code{\link[fpc]{pamk}}.
#'
#' }
#'
#' Auxiliary variables \eqn{X_{1}, X_{2}, X_{3}}, direct estimation \eqn{Y_{1}, Y_{2}, Y_{3}}, sampling variance-covariance \eqn{v_{1}, v_{2}, v_{3}, v_{12}, v_{13}, v_{23}}, and cluster \eqn{c1, c2, c3} are combined into a data frame called datasaem.ns. For more details about the structure of covariance matrix, it is available in supplementary materials of Reference.
#'
...
#'   \item{c1}{Cluster of Y1}
#'   \item{c2}{Cluster of Y2}
#'   \item{c3}{Cluster of Y3}
#' }
#'
